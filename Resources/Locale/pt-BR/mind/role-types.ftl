role-type-crew-aligned-name =  Equipe Alinhada

role-type-solo-antagonist-name = Antagonista Solo
...
role-subtype-subverted = Subvertidos

role-subtype-paradox-clone = Paradoxo.

role-subtype-wizard = Feiticeiro.
