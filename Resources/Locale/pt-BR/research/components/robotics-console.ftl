robotics-console-window-title = Console Robótica

robotics-console-no-cyborgs =  Não Cyborgs!
...
robotics-console-cyborg-destroying = { $name }  Está sendo detonado remotamente!
