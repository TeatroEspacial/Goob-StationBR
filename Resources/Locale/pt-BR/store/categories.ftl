...
store-category-debug2 = Depurar categoria 2

store-category-weapons =  Arma de armas.
...
store-category-disruption = Disrupção
...
store-category-wearables = Vestidos

store-category-contractor = Empreiteiro
