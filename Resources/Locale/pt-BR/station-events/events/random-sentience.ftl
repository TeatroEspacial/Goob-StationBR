random-sentience-event-data-1 = Escaneamentos de nossos sensores de longo alcance.

random-sentience-event-data-2 =  nossos sofisticados modelos probabilísticos.

random-sentience-event-data-3 =  Nossa onipotência

random-sentience-event-data-4 = O tráfego de comunicações em sua estação

random-sentience-event-data-5 = Emissões de energia que detectamos
...
station-event-random-sentience-announcement =
     Baseado em { $data } Nós acreditamos que alguns dos canais { $amount ->
        [1] { $kind1 }
        [2] { $kind1 } e { $kind2 }
        [3] { $kind1 }, { $kind2 }, e { $kind3 }
       *[other] { $kind1 }, { $kind2 }, { $kind3 }, etc.
    } Seres se desenvolveram. { $strength }  Inteligência de nível, e a habilidade de se comunicar.

station-event-random-sentience-role-description =  Você é um senciente. { $name }, trazido à vida através da magia do espaço.
...
station-event-random-sentience-flavor-slime = Lixo.
