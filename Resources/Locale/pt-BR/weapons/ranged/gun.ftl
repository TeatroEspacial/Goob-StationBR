...
gun-set-fire-mode = - Pronto para... { $mode }
...
gun-ballistic-transfer-target-full = { CAPITALIZE(THE($entity)) }  Já está totalmente carregada.

# CartridgeAmmo
gun-cartridge-spent = É mesmo. [color=red] gastada[/color].
...
gun-chamber-bolt-opened = - Abra o parafuso.

gun-chamber-bolt-close =  Feche o parafuso.
